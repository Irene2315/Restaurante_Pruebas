				...
				<thead>
					<tr>
						...
						<c:if test="${sessionScope.usuarioLogueado.rol.id == 1}">
							<td><a href="InsertarUsuario" class="btn btn-dark">Registrar
							</a></td>
						</c:if>
				...
				<tbody>
					...
					<c:forEach items="${usuarios}" var="usuario">
						<tr>
							...
							<c:if test="${sessionScope.usuarioLogueado.rol.id == 1}">
								<td><a href="ModificarUsuario?cUsuario=${usuario.cUsuario}"
									class="btn btn-secondary ">Modificar </a></td>
								<td><a href="EliminarUsuario?cUsuario=${usuario.cUsuario}"
